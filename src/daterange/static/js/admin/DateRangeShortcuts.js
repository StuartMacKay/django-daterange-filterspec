...
// IMPORTANT: This file was copied verbatim from the Django distribution. There
// is only one change on line 374 to change the position of the calendar from the
// left side of the widget to the right.
...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        openCalendar: function(num) {
            ...
            // is it left-to-right or right-to-left layout ?
            if (window.getComputedStyle(document.body).direction !== 'rtl') {
                cal_box.style.left = findPosX(cal_link) - 237 + 'px';
            }
            else {
                // since style's width is in em, it'd be tough to calculate
                // px value of it. let's use an estimated px for now
